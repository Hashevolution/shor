...
For phase noise on Shor-class algorithms, this bound rules out asymptotic SR-based factoring speedup: as N grows, the gap `|p_0 - ρ|` does not produce O(1/log N) speedups; our N ∈ {437, 1147, 2491, 4087} measurements show |Δ| ∼ O(0.2–0.6) without N-dependent scaling toward 1. This is formalized as **Theorem 6 (§3.3.ter)**, which also shows the swing is never tunable to an interior optimum regardless of the sign of `p_0 − ρ`.
